...
file(READ ${CGET_CMAKE_ORIGINAL_SOURCE_FILE} _fmt_upstream)
string(REGEX REPLACE "^cmake_minimum_required\\([^)]*\\)\r?\n" "" _fmt_upstream "${_fmt_upstream}")
string(REGEX REPLACE "\nproject\\(FMT[ ]+CXX\\)\\s*\r?\n" "\n" _fmt_upstream "${_fmt_upstream}")
file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/fmt-upstream.cmake "${_fmt_upstream}")
include(${CMAKE_CURRENT_BINARY_DIR}/fmt-upstream.cmake)
