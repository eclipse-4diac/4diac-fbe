...
if (CMAKE_CROSSCOMPILING)
  ...
  if (NOT EXISTS "${HOST_CC}")
	  message(FATAL_ERROR "LUAJit needs a ${host_arch} crosscompiler, but ${HOST_CC} could not be found.")
  endif()
endif()
...
add_custom_target(build-all ALL
  VERBATIM
  COMMAND make -C src MACOSX_DEPLOYMENT_TARGET=20.02 "HOST_CC=${HOST_CC} -static" "PREFIX=${CMAKE_INSTALL_PREFIX}" "TARGET_SYS=${CMAKE_SYSTEM_NAME}" "STATIC_CC=${CMAKE_C_COMPILER}" "TARGET_LD=${CMAKE_C_COMPILER}" "TARGET_AR=${CMAKE_AR} rcus" "TARGET_STRIP=${CMAKE_STRIP}" "CCOPT=${CMAKE_C_FLAGS}" "BUILDMODE=static" "XCFLAGS=-DLUAJIT_DISABLE_FFI"
