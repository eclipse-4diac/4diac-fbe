...
patch(boost/interprocess/permissions.hpp "::mode_t" "uint32_t")

# internal compiler error on mingw 9.2
#string(APPEND CMAKE_STATIC_LINKER_FLAGS " -fno-lto")
#string(APPEND CMAKE_SHARED_LINKER_FLAGS " -fno-lto")
#string(APPEND CMAKE_EXE_LINKER_FLAGS " -fno-lto")
#string(APPEND CMAKE_C_FLAGS " -fno-lto")
#string(APPEND CMAKE_CXX_FLAGS " -fno-lto")
